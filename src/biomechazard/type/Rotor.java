...
public class Rotor {
	...
	public void load() {
		...
		topRegion = Core.atlas.find(topBladeName == null ? name + "-top" : /*modName*/"biomechazard-" + topBladeName + "-top");
		topRegionOutline = Core.atlas.find(topBladeName == null ? name + "-top-outline" : /*modName*/"biomechazard-" + topBladeName + "-top-outline");
	}
