...
package biomechazard.entities.bullet;
...
import biomechazard.audiovisual.BMHSoundEffects;
...
public class MineBulletType extends BulletType {
	...
	public Sound detonationSound = BMHSoundEffects.mineDetonate1;
	...
	public MineBulletType(float damage, float splashRadius, float lifetime) {
		this(damage, splashRadius, lifetime, /*modName +*/ "biomechazard-mine");
	}

	public MineBulletType(float damage, float splashRadius) {
		this(damage, splashRadius, 25 * 60, /*modName +*/ "biomechazard-mine");
	}

	public MineBulletType() {
		this(550, 64, 25 * 60, /*modName +*/ "biomechazard-mine");
	}
