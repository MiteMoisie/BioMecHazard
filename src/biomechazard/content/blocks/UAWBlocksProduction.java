...
import biomechazard.world.blocks.production.*;
import biomechazard.world.drawer.*;
	...
	public static void load() {
		...
		cryofluidBlender = new GenericCrafter("cryofluid-blender") {{
			...
			drawer = new DrawMulti(new DrawRegion("-bottom"), new DrawPistons(){{
                sinMag = 5f * px;
                sinScl = 6f;
            }}, new DrawRegion("-mid"), new DrawLiquidTile(Liquids.cryofluid, 40 * px), new DrawDefault(), new DrawGlowRegion(){{
                alpha = 0.6f;
