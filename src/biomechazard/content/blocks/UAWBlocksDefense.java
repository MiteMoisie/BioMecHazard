...
* Tourelles, Murs et blocks utilitaires du mod UAW
*/
...
public class UAWBlocksDefense {
	...
	public static void load() {
		...
		deadeye = new ItemTurret("deadeye") {{
			...
			shootSound = BMHSoundEffects.cannonShootBig2;
		...
		zounderkite = new UAWItemTurret("zounderkite") {{
			...
			shootSound = BMHSoundEffects.launcherShoot1;
		...
		tempest = new ItemTurret("tempest") {{
			...
			ammoUseEffect = Fx.casing3;
			shootSound = BMHSoundEffects.gunShoot4;
